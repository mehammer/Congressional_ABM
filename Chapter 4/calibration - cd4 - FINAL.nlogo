...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 40910 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 13268 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 38698 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 17691 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 100891 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 32721 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 95437 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 43629 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 72728 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 23588 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 68797 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 31450 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 5310 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 1722 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 5023 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 2296 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Don McEachin
    ...
    set xcor -5
    set ycor 5
    set nominate_dim1 -0.381
    set nominate_dim2 -0.017
    set adaptation strategy1
  ]

  ask candidates 1  [ ;Leon Benjamin
    ...
    set xcor 5
    set ycor 5
    set nominate_dim1 0.018
    set nominate_dim2 -0.033
...
<experiments>
  ...
  <experiment name="va04 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va04 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va04 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va04 - candidate distance" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
