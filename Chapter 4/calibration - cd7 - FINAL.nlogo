...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 47272 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 25113 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 45795 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 29545 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 47345 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 25152 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 45866 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 29591 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 84040 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 44646 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 81413 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 52525 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 5852 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 3109 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 5669 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 3657 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Abigail Spanberger - incumbent
    set party  "democrat"
    set shape "star"
    set label "democrat"
    set color red
    ...
    set xcor -5
    set ycor 5
    set nominate_dim1 -0.188
    set nominate_dim2 0.338
    set adaptation strategy1
  ]

  ask candidates 1  [ ;Nicholas Freitas
    ...
    set xcor 5
    set ycor 5
    set nominate_dim1 0.117
    set nominate_dim2 -0.09
...
@#$#@#$#@
<experiments>
  <experiment name="va07 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
  ...
  <experiment name="va07 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va07 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va07 - candidate distance" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
