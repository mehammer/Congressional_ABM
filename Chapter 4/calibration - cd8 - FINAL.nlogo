...
to politicians
  ...
  ask candidates 0 [ ;Beyer -- incumbent
    set party  "democrat"
    set shape "star"
    set label "democrat"
    set color red
  ...
  ask candidates 1  [ ;Jeffrey Jordan
    ...
    set xcor 5
    set ycor 5
    set nominate_dim1 0.145
    set nominate_dim2 0.016
...
<experiments>
  ...
  <experiment name="va08 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va08 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va08 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va08 - candidate distance" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
