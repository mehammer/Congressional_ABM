...
to population-attributes
  ...
  ask resident
    [ set neighborhood 1
      set party "none"
      set voter 0
      set nominate_dim1 random-normal 0.0 0.33
...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 6 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 6 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
ask resident [
    ...
    if voter_type = "WMHD" [set nominate_dim1 dem_dim1];[set nominate_dim1 random-normal -0.363 0.1]
    if voter_type = "WMCD" [set nominate_dim1 dem_dim1 + col] ;[set nominate_dim1 random-normal -0.553 0.1]
    if voter_type = "WFHD" [set nominate_dim1 dem_dim1 + w];[set nominate_dim1 random-normal -0.453 0.1]
    if voter_type = "WFCD" [set nominate_dim1 dem_dim1 + w + col];[set nominate_dim1 random-normal -0.553 0.1]
    if voter_type = "MMHD" [set nominate_dim1 dem_dim1 + race1];[set nominate_dim1 random-normal -0.363 0.1]
    if voter_type = "MMCD" [set nominate_dim1 dem_dim1 + race1 + col] ;[set nominate_dim1 random-normal -0.553 0.1]
    if voter_type = "MFHD" [set nominate_dim1 dem_dim1 + race1 + w];[set nominate_dim1 random-normal -0.553 0.1]
    if voter_type = "MFCD" [set nominate_dim1 dem_dim1 + race1 + w + col];[set nominate_dim1 random-normal -0.653 0.1]
    if voter_type = "WMHR" [set nominate_dim1 rep_dim1];[set nominate_dim1 random-normal 0.397 0.1]
    if voter_type = "WMCR" [set nominate_dim1 rep_dim1 + col];[set nominate_dim1 random-normal 0.207 0.1]
    if voter_type = "WFHR" [set nominate_dim1 rep_dim1 + w];[set nominate_dim1 random-normal 0.107 0.1]
    if voter_type = "WFCR" [set nominate_dim1 rep_dim1 + w + col];[set nominate_dim1 random-normal 0.107 0.1]
    if voter_type = "MMHR" [set nominate_dim1 rep_dim1 + race1];[set nominate_dim1 random-normal 0.397 0.1]
    if voter_type = "MMCR" [set nominate_dim1 rep_dim1 + race1 + col];[set nominate_dim1 random-normal 0.207 0.1]
    if voter_type = "MFHR" [set nominate_dim1 rep_dim1 + race1 + w];[set nominate_dim1 random-normal 0.107 0.1]
    if voter_type = "MFCR" [set nominate_dim1 rep_dim1 + race1 + col];[set nominate_dim1 random-normal 0.107 0.1]
...
to politicians
  ...
  ask candidates 0 [ ;Qasim Rashid
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 random-normal -0.1 0.2
    set nominate_dim2 random-normal -0.1 0.2
...
to dem-entry
;;;CURRENTLY GENERATES 1 FOR EITHER CONDITION
  ;;;MODIFY TO GENERATE UP TO 1 PER *EACH* CONDITION -- FLANK IS PARTISAN, CENTER IS INDEPENDENT (5/23/25)

  let condition1? false
  ;let condition2? false

  ;let electorate-pos average-position voters -- I think cohorts cover this (cohort0 for Dem, cohort1 for Rep)
...
to generate-dem
  ...
  create-candidate 1 [
    ...
    let x-mid [nominate_dim1] of candidates 0 + -0.2
    let y-mid [nominate_dim2] of candidates 0 + -0.2
...
to generate-rep
  ...
  create-candidate 1 [
    ...
    let x-mid [nominate_dim1] of candidates 1 + 0.2
    let y-mid [nominate_dim2] of candidates 1 + 0.2
    set nominate_dim1 x-mid
    set nominate_dim2 y-mid
    set xcor x-mid * 10
    set ycor y-mid * 10
...
@#$#@#$#@
<experiments>
  <experiment name="experiment5" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
  ...
  <experiment name="experiment10" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
