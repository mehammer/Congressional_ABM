...
to politicians
  ...
  ask candidates 1  [ ;Scott Taylor
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 0.009
    set nominate_dim2 0.005
...
<experiments>
  <experiment name="va02 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="centrifgual">
      <value value="0.08"/>
      <value value="1"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="va02 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va02 - 10run" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
