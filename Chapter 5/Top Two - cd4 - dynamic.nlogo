...
globals [
 ...
 ; %voters
  ...
  strategy
  messaging
  ;centrist-entry ;determines if a new candidate enters the race based on space in the middle
  ;partisan-entry; determines if a new candidate enters the race based on space in the flank
...
<experiments>
  ...
  <experiment name="va04 - 5runs" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va04 - 10runs" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
