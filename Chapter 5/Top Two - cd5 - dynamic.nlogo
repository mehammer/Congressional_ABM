...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 56440 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 18305 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 56440 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 22881 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 43361 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 14063 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 43361 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 17579 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 104817 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 33995 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 104817 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 42493 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 8881 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 2880 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 8881 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 3600 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Webb
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 -0.191
    set nominate_dim2 -0.045
    set adaptation strategy1
    set finalist 0
  ]

  ask candidates 1  [ ;Good
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 0.069
    set nominate_dim2 -0.020
...
@#$#@#$#@
<experiments>
  <experiment name="va05 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
  ...
  <experiment name="va05 - 5runs" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va05 -10runs" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
