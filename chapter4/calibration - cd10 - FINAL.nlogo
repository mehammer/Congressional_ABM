...
to setup ;initial population and environment setup
  ...
  ;set messaging 0.1
   ...
   set tot_vap 554687
   ;set white_vap 416210
   ;set minority_vap 166730
...
to politicians
  ...
  ask candidates 0 [ ;Wexton -- incumbent
    set party  "democrat"
    set shape "star"
    set label "democrat"
    set color red
  ...
  ask candidates 1  [ ;Alicia Andrews
...
@#$#@#$#@
<experiments>
  <experiment name="DO NOT USE - 25apr2025" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
  ...
  <experiment name="DO NOT USE - 28apr2025" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va10 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va10 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va10 - candidate distance" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
