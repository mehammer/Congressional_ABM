...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 27313 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 7188 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 28031 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 9344 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 107857 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 28383 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 110695 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 36898 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 66869 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 17597 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 68628 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 22876 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 9379 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 2468 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 9626 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 3209 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Robert Scott - incumbent
    set party  "democrat"
    set shape "star"
    set label "democrat"
    set color red
    ...
    set xcor -5
    set ycor 5
    set nominate_dim1 -0.45
    set nominate_dim2 0.012
    set adaptation strategy1
  ]

  ask candidates 1  [ ;John Collick
    ...
    set xcor 5
    set ycor 5
    set nominate_dim1 0.094
    set nominate_dim2 -0.028
...
@#$#@#$#@
<experiments>
  <experiment name="va03 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
  ...
  <experiment name="va03 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va03 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va03 - candidate distance" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
