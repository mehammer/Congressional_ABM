...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 52112 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 15493 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 52112 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 19718 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 33089 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 9837 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 33089 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 12520 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 127586 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 37931 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 127586 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 48276 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 2877 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 855 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 2877 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 1089 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
ask resident [
    ...
    if voter_type = "WFHR" [set nominate_dim1 rep_dim1]
    if voter_type = "WFCR" [set nominate_dim1 rep_dim1 + col]
...
to politicians
  ...
  ask candidates 0 [ ;Nicholas Betts
    set party  "democrat"
    set shape "star"
    set label "democrat"
    set color red
    ...
    set xcor -5
    set ycor 5
    set nominate_dim1 0.012
    set nominate_dim2 -0.05
    set adaptation strategy1
  ]

  ask candidates 1  [ ;Benjamin Cline - incumbent
    ...
    set xcor 5
    set ycor 5
    set nominate_dim1 0.72
    set nominate_dim2 -0.202
...
@#$#@#$#@
<experiments>
  <experiment name="va06 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
  ...
  <experiment name="va06 - 5run" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va06 - 10run" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va06 - candidate distance" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="5"/>
    <metric>median [c1_distance] of resident with [voter = 1]</metric>
