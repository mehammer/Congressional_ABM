...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 40984 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 40984 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 37706 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 42624 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 38494 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 38494 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 35414 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 40033 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 54328 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 54328 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 49982 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 56501 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 6266 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 6266 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 5765 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 6517 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Wexton
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 -0.369
    set nominate_dim2 0.313
    set adaptation strategy1
    set finalist 0
  ]

  ask candidates 1  [ ;Andrews
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 0.146
    set nominate_dim2 -0.076
...
@#$#@#$#@
<experiments>
  <experiment name="va10 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
  ...
  <experiment name="va10 - 5runs" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va10 - 10runs" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
