...
;;THE n-of VALUE IS THE REAL ESTIMATED SUBPOPULATION NUMBER FOR THE DISTRICT FROM THE POP_DISTRIBUTION FILE
  ask n-of 40360 resident with [race = "none"][set race "white" set voter_type "WMHD"]
  ask n-of 45625 resident with [race = "none"][set race "white" set voter_type "WMCD"]
  ask n-of 43870 resident with [race = "none"][set race "white" set voter_type "WFHD"]
  ask n-of 45625 resident with [race = "none"][set race "white" set voter_type "WFCD"]
  ask n-of 45811 resident with [race = "none"][set race "minority" set voter_type "MMHD"]
  ask n-of 51787 resident with [race = "none"][set race "minority" set voter_type "MMCD"]
  ask n-of 49795 resident with [race = "none"][set race "minority" set voter_type "MFHD"]
  ask n-of 51787 resident with [race = "none"][set race "minority" set voter_type "MFCD"]
  ask n-of 23704 resident with [race = "none"][set race "white" set voter_type "WMHR"]
  ask n-of 26796 resident with [race = "none"][set race "white" set voter_type "WMCR"]
  ask n-of 25765 resident with [race = "none"][set race "white" set voter_type "WFHR"]
  ask n-of 26796 resident with [race = "none"][set race "white" set voter_type "WFCR"]
  ask n-of 7458 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 8430 resident with [race = "none"][set race "minority" set voter_type "MMCR"]
  ask n-of 8106 resident with [race = "none"][set race "minority" set voter_type "MMHR"]
  ask n-of 8430 resident with [race = "none"][set race "minority" set voter_type "MFHR"]
...
to politicians
  ...
  ask candidates 0 [ ;Connolly
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 -0.307
    set nominate_dim2 -0.038
    set adaptation strategy1
    set finalist 0
  ]

  ask candidates 1  [ ;Anantatmula
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 0.07
    set nominate_dim2 0.010
...
@#$#@#$#@
<experiments>
  <experiment name="va11 - cand sweep simple centers" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
  ...
  <experiment name="va11 - 5runs" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va11 - 10runs" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
