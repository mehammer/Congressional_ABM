...
to politicians
  ...
  ask candidates 1  [ ;Freitas
    ...
    set ycor 5
    set cid (word "C" who)
    set nominate_dim1 0.177
    set nominate_dim2 -0.090
...
<experiments>
  ...
  <experiment name="va07 - 5runs" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
  ...
  <experiment name="va07 - 10runs" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count resident with [voter = 1]</metric>
